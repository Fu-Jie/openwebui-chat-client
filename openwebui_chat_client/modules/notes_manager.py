...
class NotesManager:
    ...
    def get_notes_list(self) -> Optional[List[Dict[str, Any]]]:
        ...
        try:
            ...
            logger.info(
                f"Successfully retrieved notes list with {len(notes_list)} items."
            )
            return notes_list
        except requests.exceptions.RequestException as e:
    ...
    def create_note(
        ...
        try:
            ...
            logger.info(
                f"Successfully created note: {created_note.get('id', 'unknown')}"
            )
            return created_note
        except requests.exceptions.RequestException as e:
        ...
        try:
            ...
            try:
                ...
                if response_data is False:
                    logger.warning(
                        f"Server returned failure status for note deletion: {note_id}"
                    )
                    return False
