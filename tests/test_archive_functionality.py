...
class TestArchiveFunctionality(unittest.TestCase):
    ...
    def test_archive_chats_by_age_no_folder(
        self, mock_archive, mock_details, mock_list
    ):
    ...
    @patch.object(OpenWebUIClient, "archive_chat")
    def test_archive_chats_by_age_with_folder(
        self, mock_archive, mock_folder_chats, mock_folder_id
    ):
        ...
        mock_folder_chats.return_value = [
            {
                "id": "chat1",
                "title": "Old Chat in Folder",
                "updated_at": old_time,
                "folder_id": "folder1",
            },
            {
                "id": "chat2",
                "title": "Recent Chat in Folder",
                "updated_at": current_time,
                "folder_id": "folder1",
            },
        ]
    ...
    @patch.object(OpenWebUIClient, "_get_chat_details")
    @patch.object(OpenWebUIClient, "archive_chat")
    def test_archive_chats_by_age_archive_failure(
        self, mock_archive, mock_details, mock_list
    ):
