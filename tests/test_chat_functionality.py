...
class TestOpenWebUIClientChatFunctionality(unittest.TestCase):
    ...
    @patch.object(OpenWebUIClient, '_ask')
    def test_chat_with_folder(self, mock_ask, mock_move, mock_create_folder, mock_get_folder, mock_find_create):
    ...
    def test_parallel_chat_success(self, mock_as_completed, mock_executor, mock_update, mock_get_response, mock_find_create):
    ...
    @patch.object(OpenWebUIClient, 'set_chat_tags')
    def test_stream_chat_success(self, mock_set_tags, mock_ask_stream, mock_find_create):
    ...
    def test_set_chat_tags_empty_list(self):
        ...
        with patch('openwebui_chat_client.openwebui_chat_client.requests.Session.get') as mock_get:
    ...
    def test_switch_chat_model_success(self, mock_update, mock_load):
        ...
        self.assertEqual(self.client.chat_object_from_server["chat"]["models"], [new_model])
