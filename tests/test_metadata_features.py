...
class TestMetadataFeatures(unittest.TestCase):
    ...
    @patch(
        "openwebui_chat_client.openwebui_chat_client.OpenWebUIClient._get_task_model"
    )
    ...
    @patch(
        "openwebui_chat_client.openwebui_chat_client.OpenWebUIClient._find_or_create_chat_by_title"
    )
    ...
    def test_chat_with_auto_metadata(
        self,
        mock_rename_chat,
        mock_set_chat_tags,
        mock_find_create,
    ...
    @patch(
        "openwebui_chat_client.openwebui_chat_client.OpenWebUIClient._load_chat_details"
    )
    @patch("openwebui_chat_client.openwebui_chat_client.OpenWebUIClient._get_title")
    @patch("openwebui_chat_client.openwebui_chat_client.OpenWebUIClient._get_tags")
    @patch("openwebui_chat_client.openwebui_chat_client.OpenWebUIClient.set_chat_tags")
    ...
    def test_update_chat_metadata(
        ...
        result = self.client.update_chat_metadata(
            chat_id=self.mock_chat_id, regenerate_tags=True, regenerate_title=True
        )
        ...
        mock_get_tags.assert_called_once()
        mock_get_title.assert_called_once()
        mock_set_chat_tags.assert_called_with(
            self.mock_chat_id, ["updated", "metadata"]
        )
