...
class TestOpenWebUIClientUserIntegration(unittest.TestCase):
    ...
    def test_user_manager_initialized(self):
        ...
        self.assertEqual(
            self.client._user_manager.base_client, self.client._base_client
        )
    ...
    def test_get_users_delegation(self):
        ...
        with patch.object(
            self.client._user_manager, "get_users", return_value=[]
        ) as mock_method:
    ...
    def test_update_user_role_delegation(self):
        ...
        with patch.object(
            self.client._user_manager, "update_user_role", return_value=True
        ) as mock_method:
