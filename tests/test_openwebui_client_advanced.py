...
class TestUpdateChatMetadata(unittest.TestCase):
    ...
    def test_update_chat_metadata_regenerate_tags(self, mock_load, mock_build_history, 
                                                   mock_get_tags, mock_set_tags):
    ...
    @patch.object(OpenWebUIClient, '_build_linear_history_for_api')
    @patch.object(OpenWebUIClient, '_load_chat_details')
    def test_update_chat_metadata_regenerate_title(self, mock_load, mock_build_history,
                                                    mock_get_title, mock_rename):
    ...
    @patch.object(OpenWebUIClient, '_build_linear_history_for_api')
    @patch.object(OpenWebUIClient, '_load_chat_details')
    def test_update_chat_metadata_no_tags_generated(self, mock_load, mock_build_history, mock_get_tags):
